      ...
      <div className="bg-gray-100 px-4 py-5 text-blue-700 w-screen 
        ...
        >
          ...
          <img
            ...
            width="180px"
          />
          {/* <a href="https://slack.com/oauth/v2/authorize?client_id=401428056419.1387902464068&scope=channels:read,chat:write,groups:read,im:history,im:read,mpim:read,chat:write.customize&user_scope=channels:read"
